...
def import_location(csv_path):
    ...
    client.connect()
    if not client.collections.exists("Organization"):
    ...
    with open(csv_path, mode='r', newline='', encoding="utf-8") as csv_file:
        ...
        for row in reader:
            ...
            name_de = row[1]
            name_fr = row[2]
            desc_vector = embed_text(name_de)
            client.collections.get("Organization").data.insert(
                    properties={
                        "name_de": name_de,
                        "name_fr": name_fr,
                        "type": type_name,
...
if __name__ =="__main__":
    import_location("C:/Users/Silvan/Data/ReferenceData/LINDAS_CSV/Amt.csv")
