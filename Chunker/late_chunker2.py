...
def merge_and_limit_chunks(chunked_data, max_tokens):
    """Merge single-line chunks where possible, but never exceed max_tokens."""
    merged = []
    for chunk, span in chunked_data:
        ...
        if merged:
            ...
            # Only merge a single-line chunk if it fits in the limit
...
def process_file(file_path):
    ...
    if num_tokens <= TOKEN_LIMIT:
        ...
        # Merge single-line chunks w/ length limit
